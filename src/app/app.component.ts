...
export class AppComponent {
  ...
  onSubmit() {
    ...
    const resume = {
      ...
      about: this.about,
      careerObjectives: this.career,
      education: this.education,
      workExperience: [
        {
          startDate: this.job1Start,
          endDate: this.job1End,
          details: this.job1Details
        },
        {
          startDate: this.job2Start,
          endDate: this.job2End,
          details: this.job2Details
        },
        {
          startDate: this.job3Start,
          endDate: this.job3End,
          details: this.job3Details
        }
      ],
      references: this.references
    };

    // Example: Log the constructed resume object
    console.log(resume);

    // Here, you can send the resume data to a server, or perform any other actions
    // like displaying a success message, etc.
  }
}
// const getState = () => {
//   const $ = (element) => {
